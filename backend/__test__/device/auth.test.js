...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Norval40',
      password: 'Vi_8HSvZdf2pJfY',
      email: 'Katelyn_Block48@yahoo.com',
      name: 'Lloyd Nienow',
      userType: 906,
      mobileNo: '(544) 600-7783',
      resetPasswordLink: {},
      loginRetryLimit: 643,
      loginReactiveTime: '2025-07-26T03:35:29.227Z',
      id: '66ae31cfb73981034b5bbca3'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Kristoffer_Kihn55',
        'password':'GOqEm4yKq7AVNjl',
        'email':'Domenick.Pfannerstill@hotmail.com',
        'name':'Grady Watsica',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(004) 034-1862',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Domenick.Pfannerstill@hotmail.com', });
