...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Lexus.Wisoky90',
      password: 'NP2vr2epoQDVv30',
      email: 'Gaylord_Hintz@hotmail.com',
      name: 'Virgil Reinger',
      userType: 458,
      mobileNo: '(415) 397-8992',
      resetPasswordLink: {},
      loginRetryLimit: 122,
      loginReactiveTime: '2024-08-04T09:59:47.915Z',
      id: '66ae47acdd20fa03e91559d6'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Carter.Bosco',
        'password':'NUv1rhSW49_Ym8r',
        'email':'Demario.Anderson48@gmail.com',
        'name':'Martin Heathcote',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'(663) 883-7315',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Demario.Anderson48@gmail.com', });
